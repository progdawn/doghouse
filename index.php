                    ...
                    if(mysqli_stmt_execute($stmt)){
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            echo '<div class="col-md-6 col-lg-4 item">
                                <a data-toggle="modal" data-target="#image-modal" href="#image-modal" data-name="'.$row["name"].'" class="openImageDialog">
                                    <img class="img-fluid image scale-on-hover" src="'.$row["name"].'">
                                </a>
                            </div>';
                        }
                        echo '</div>
